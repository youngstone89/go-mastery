...
import (
	...
	essearch "go-mastery/pkg/elasticsearch"
...
func Test_DefaultBulkWrite(t *testing.T) {
	testCases := []struct {
		desc string
	}{
		{
...
func Test_IndexerBulkWrite(t *testing.T) {
	var articles []*essearch.Article
